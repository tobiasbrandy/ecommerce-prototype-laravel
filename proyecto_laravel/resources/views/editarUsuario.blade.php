        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/editarUsuario') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('old_password') ? ' has-error' : '' }}">
                            <label for="old_password" class="col-md-4 control-label">Password Antigua</label>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <input id="avatar" type="file" name="avatar" class="form-control"></input>
                          </div>
                        </div>
